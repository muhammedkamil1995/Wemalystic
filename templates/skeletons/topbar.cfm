<nav class="nav navbar navbar-expand-xl navbar-light wemalytics-navbar">
    <div class="container-fluid navbar-inner">
        <a href="../dashboard/index.html" class="navbar-brand">
            <div class="logo-main">
                <div class="logo-normal">
                    <img src="assets/images/wema-logo.png" width="26" alt="loader" class="">
                </div>
                <div class="logo-mini">
                    <img src="assets/images/wema-logo.png" width="26" alt="loader" class=" ">
                </div>
            ...
            <h4 class="logo-title d-block d-xl-none" data-setting="app_name">Wemalytics</h4>
        </a>
        ...
        <div class="d-flex align-items-center justify-content-between product-offcanvas">
            ...
            <div class="offcanvas offcanvas-end shadow-none wemalytics-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
                <div class="offcanvas-body">
                    <ul class="wemalytics-nav-menu list-unstyled" id="quickNavigation">
                        <li class="nav-item ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-arrow justify-content-start" data-bs-toggle="collapse" href="#quickAppsData" role="button" aria-expanded="false" aria-controls="quickAppsData">
                            ...
                            <span class="nav-text ms-2">Quick Apps</span>
                            </a>
                            <ul class="wemalytics-header-sub-menu list-unstyled collapse" id="quickAppsData">
                                <li class="nav-item">
                                    <a class="nav-link menu-arrow " data-bs-toggle="collapse" href="#" role="button" aria-expanded="false" aria-controls="quickAppsData">
                                        MPR
                                    </a>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-arrow justify-content-start" data-bs-toggle="collapse" href="#quickReportsData" role="button" aria-expanded="false" aria-controls="quickReportsData">
                             <svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="nav-text ms-2">Quick Reports </span>
                            </a>
                            <ul class="wemalytics-header-sub-menu list-unstyled collapse" id="quickReportsData">
                                <li class="nav-item">
                                    <a class="nav-link menu-arrow" data-bs-toggle="collapse" href="#" role="button" aria-expanded="false" aria-controls="quickReportsData">
                                        Deposit Report
                                    </a>
                                </li>
                                <li class="nav-item">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                ...
                <li class="nav-item wemalytics-full-screen d-none  d-xl-block border-end" id="fullscreen-item">
                ...
                <li class="nav-item dropdown">
                    <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <img src="assets/images/avatars/04.png" alt="User-Profile" class="img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                        <div class="caption ms-3 d-none d-md-block ">
                            <h6 class="mb-0 caption-title">Olubunmi Ogunbo</h6>
                            <p class="mb-0 caption-sub-title">Performance Manager</p>
                        </div>
                    </a>
