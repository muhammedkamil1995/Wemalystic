(function (jQuery) {
  ...
  if (document.querySelectorAll("#wemalytics-chart-box1").length) {
    const variableColors = WemaUtils.getVariableColor();
    const colors = [variableColors.warning];
    const options = {
      series: [
    ...
    const chart = new ApexCharts(
      document.querySelector("#wemalytics-chart-box1"),
      options
    );
    chart.render();
  }
  ...
  //box-chart-2
  if (document.querySelectorAll("#wemalytics-chart-box2").length) {
    const variableColors = WemaUtils.getVariableColor();
    const colors = [variableColors.tertiray];
    const options = {
      series: [
    ...
    const chart = new ApexCharts(
      document.querySelector("#wemalytics-chart-box2"),
      options
    );
    chart.render();
  }
  ...
  //box-chart-3
  if (document.querySelectorAll("#wemalytics-chart-box3").length) {
    const variableColors = WemaUtils.getVariableColor();
    const colors = [variableColors.secondary];
    const options = {
      series: [
    ...
    const chart = new ApexCharts(
      document.querySelector("#wemalytics-chart-box3"),
      options
    );
    chart.render();
  }
  ...
  //box-chart-4
  if (document.querySelectorAll("#wemalytics-chart-box4").length) {
    const variableColors = WemaUtils.getVariableColor();
    const colors = [variableColors.primary];
    const options = {
      series: [
    ...
    const chart = new ApexCharts(
      document.querySelector("#wemalytics-chart-box4"),
      options
    );
    chart.render();
  }
