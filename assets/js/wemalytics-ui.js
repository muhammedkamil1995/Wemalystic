/*
* Version: 1.0.0
* Template:Wemalytics-Ui - Responsive Bootstrap 5 Admin Dashboard Template
* Author: wesley.adu
* Design and Developed by: wesley.adu
...
(function(){
  ...
  /*------------Minus-plus--------------*/
  const plusBtns = document.querySelectorAll('.wemalytics-quantity-plus')
  const minusBtns = document.querySelectorAll('.wemalytics-quantity-minus')
...
jQuery(document).on('click', '.wemalytics-full-screen', function() {
  if (!document.fullscreenElement &&
      ...
      document.querySelector('.wemalytics-full-screen').querySelector('.normal-screen').classList.add('d-none');
      document.querySelector('.wemalytics-full-screen').querySelector('.full-normal-screen').classList.remove('d-none');
  } else {
      ...
      document.querySelector('.wemalytics-full-screen').querySelector('.full-normal-screen').classList.add('d-none');
      document.querySelector('.wemalytics-full-screen').querySelector('.normal-screen').classList.remove('d-none');
  }
});
...
$('.wemalytics-status').on('change',function(){
  const status = $(this).is(":checked")
  if(status){
      $(".wemalytics-reset-status").text("Online")
  } else{
      $(".wemalytics-reset-status").text("Offline")
  }
})
